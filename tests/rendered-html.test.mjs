...
test("server-renders the portfolio landing page", async () => {
  ...
  assert.match(html, /https:\/\/github\.com\/Grand-slam-project\/Trading/);
  assert.match(html, /portfolio-assets\/ai-trading\.png/);
  assert.match(html, /portfolio-assets\/subway-dashboard-cropped\.png/);
  assert.match(html, /huggingface\.co\/spaces\/heesung00\/Decafe_line1_8/);
  assert.match(html, /huggingface\.co\/spaces\/heesung00\/decaf_line2/);
...
test("keeps the portfolio structure and product interactions in sync", async () => {
  ...
  assert.match(page, /https:\/\/github\.com\/Grand-slam-project\/Trading/);
  assert.match(page, /portfolio-assets\/subway-dashboard-cropped\.png/);
  assert.match(page, /huggingface\.co\/spaces\/heesung00\/Decafe_line1_8/);
  assert.match(page, /huggingface\.co\/spaces\/heesung00\/decaf_line2/);
